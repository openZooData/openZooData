"""
routes/enclosures.py — Enclosure-Species-Endpoints
...
GET  /api/v1/zoos/<zoo>/enclosures       → alle enclosure_species des Zoos
POST /api/v1/zoos/<zoo>/enclosures       → neue enclosure_species anlegen
PUT  /api/v1/zoos/<zoo>/enclosures/<id>  → enclosure_species bearbeiten
DELETE /api/v1/zoos/<zoo>/enclosures/<id> → enclosure_species löschen
...
@enclosures_bp.route("/api/v1/zoos/<zoo>/enclosures/<int:es_id>", methods=["PUT"])
@limiter.limit("30 per minute")
...
@enclosures_bp.route("/api/v1/zoos/<zoo>/enclosures/<int:es_id>", methods=["DELETE"])
