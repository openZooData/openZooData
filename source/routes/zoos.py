...
# ── Location Types ────────────────────────────────────────────────────────────
#
# Lesen:     alle JWT-User (require_authenticated)
# Schreiben: nur super_admin
###############################################################################

@zoos_bp.route("/api/v1/location-types", methods=["GET"])
@limiter.limit("60 per minute")
...
@zoos_bp.route("/api/v1/location-types/<int:type_id>", methods=["GET"])
@limiter.limit("60 per minute")
...
@zoos_bp.route("/api/v1/location-types", methods=["POST"])
@limiter.limit("30 per minute")
...
@zoos_bp.route("/api/v1/location-types/<int:type_id>", methods=["PUT"])
@limiter.limit("30 per minute")
...
@zoos_bp.route("/api/v1/location-types/<int:type_id>", methods=["DELETE"])
@limiter.limit("10 per minute")
