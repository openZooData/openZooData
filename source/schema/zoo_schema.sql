...
CREATE TABLE auth.user_zoo_roles (
    ...
    role character varying(20) DEFAULT 'zoo_admin'::character varying
);
...
CREATE TABLE auth.users (
    ...
    is_active boolean DEFAULT true,
    created_at timestamp with time zone DEFAULT now(),
    CONSTRAINT users_role_check CHECK (((role)::text = ANY ((ARRAY['super_admin'::character varying, 'zoo_admin'::character varying, 'moderator'::character varying])::text[])))
);
...
--
-- Name: api_keys api_keys_api_key_key; Type: CONSTRAINT; Schema: auth; Owner: -
--
...
--
-- Name: tenants tenants_zoo_id_key; Type: CONSTRAINT; Schema: auth; Owner: -
--

ALTER TABLE ONLY auth.tenants
    ADD CONSTRAINT tenants_zoo_id_key UNIQUE (zoo_id);
...
ALTER TABLE ONLY auth.user_zoo_roles
    ADD CONSTRAINT user_zoo_roles_pkey PRIMARY KEY (user_id, zoo_id);
...
--
-- Name: idx_api_keys_active; Type: INDEX; Schema: auth; Owner: -
--
...
--
-- Name: idx_api_keys_zoo_id; Type: INDEX; Schema: auth; Owner: -
--

CREATE INDEX idx_api_keys_zoo_id ON auth.api_keys USING btree (zoo_id);


--
-- Name: idx_user_zoo_roles_zoo; Type: INDEX; Schema: auth; Owner: -
--

CREATE INDEX idx_user_zoo_roles_zoo ON auth.user_zoo_roles USING btree (zoo_id);
...
--
-- Name: api_keys api_keys_zoo_id_fkey; Type: FK CONSTRAINT; Schema: auth; Owner: -
--

ALTER TABLE ONLY auth.api_keys
    ADD CONSTRAINT api_keys_zoo_id_fkey FOREIGN KEY (zoo_id) REFERENCES zoo.zoos(id) ON DELETE SET NULL;


--
-- Name: tenants tenants_zoo_id_fkey; Type: FK CONSTRAINT; Schema: auth; Owner: -
--

ALTER TABLE ONLY auth.tenants
    ADD CONSTRAINT tenants_zoo_id_fkey FOREIGN KEY (zoo_id) REFERENCES zoo.zoos(id) ON DELETE SET NULL;
...
--
-- Name: user_zoo_roles user_zoo_roles_zoo_id_fkey; Type: FK CONSTRAINT; Schema: auth; Owner: -
--

ALTER TABLE ONLY auth.user_zoo_roles
    ADD CONSTRAINT user_zoo_roles_zoo_id_fkey FOREIGN KEY (zoo_id) REFERENCES zoo.zoos(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY auth.users
    ADD CONSTRAINT users_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES auth.tenants(id) ON DELETE SET NULL;


--
-- Name: change_proposals change_proposals_proposed_by_fkey; Type: FK CONSTRAINT; Schema: community; Owner: -
--

ALTER TABLE ONLY community.change_proposals
    ADD CONSTRAINT change_proposals_proposed_by_fkey FOREIGN KEY (proposed_by) REFERENCES auth.users(id) ON DELETE SET NULL;


--
-- Name: change_proposals change_proposals_reviewed_by_fkey; Type: FK CONSTRAINT; Schema: community; Owner: -
--

ALTER TABLE ONLY community.change_proposals
    ADD CONSTRAINT change_proposals_reviewed_by_fkey FOREIGN KEY (reviewed_by) REFERENCES auth.users(id) ON DELETE SET NULL;
...
--
-- Name: releases releases_released_by_fkey; Type: FK CONSTRAINT; Schema: community; Owner: -
--

ALTER TABLE ONLY community.releases
    ADD CONSTRAINT releases_released_by_fkey FOREIGN KEY (released_by) REFERENCES auth.users(id) ON DELETE SET NULL;
...
--
-- Name: media media_uploaded_by_fkey; Type: FK CONSTRAINT; Schema: zoo; Owner: -
--
